...
Now, let's write the `weights.csv` file to the `/output` directory.
...
We can download daily returns for the S&P 500 from January 02, 1986 through June 29, 2018. The data comes from [this Kaggle webpage](https://www.kaggle.com/pdquant/sp500-daily-19862018).
